                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-pane" id="settings">
                            <form id="myForm" method="post" action="{{ route('update.menu') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" value="{{ $editMenu->name }}">
                                        </div>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="category_id" class="form-select" id="example-select">
                                                ...
                                                @foreach ($category as $cat)
                                                    <option value="{{ $cat->id }}"{{ $cat->id == $editMenu->category_id ? 'selected' : '' }}>{{ $cat->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="price" class="form-control" value="{{ $editMenu->price }}">
                                        </div>
                                    </div>
                                    <!-- end col -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="selectize-tags" name="mealtag" value="{{ $editMenu->mealtag }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mt-3">
                                            <div class="form-check">
                                                <input type="radio" id="customRadio1" value="available" name="status" class="form-check-input"
                                                    {{ $editMenu->status == 'available' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="customRadio1">Available</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="radio" id="customRadio2" value="notavailable" name="status" class="form-check-input"
                                                    {{ $editMenu->status == 'notavailable' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="customRadio2">Temporary Out of Service</label>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control"name="description" id="example-textarea" rows="5">{{ $editMenu->description }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <img id="showImage" src="{{ asset($editMenu->image) }}"
